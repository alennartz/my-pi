...
Wait for `<group_idle>`, then merge their findings into the final review document (section 3). Deduplicate if both flagged the same issue; preserve the more detailed write-up.
