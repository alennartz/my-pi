...
Include both [SKILL.md](SKILL.md) vocabulary and glossary.md vocabulary in the brief so each subagent names things consistently with the architecture language and the project's domain language.
